...
CREATE TABLE TOTALMODEMS (
ID_NODE INT NOT NULL,
CANTIDAD INT DEFAULT 0,
CONSTRAINT FK_ID_NODE_TOTALMODEMS FOREIGN KEY (ID_NODE) REFERENCES NODES (ID)
);
...
VALUES ("PLANOXXXX", "-", "LIMA");
SELECT ID FROM NODES WHERE PLANO = "PLANOXXXX";

SET SQL_SAFE_UPDATES = 0;
DELETE FROM NODES WHERE PLANO = "PLANOXXXX";

SELECT * FROM NODES;

INSERT INTO NEW_QOE (ID_NODE) VALUES (3627);
INSERT INTO NEW_HOURS (ID_NODE) VALUES (3627);
            INSERT INTO PERIOD (ID_NODE) VALUES (3627);
            INSERT INTO MODULATION (ID_NODE) VALUES (3627);
            INSERT INTO IMPACTEDMODEMS (ID_NODE) VALUES (3627);
            INSERT INTO STRESSEDMODEMS (ID_NODE) VALUES (3627);
            INSERT INTO TOTALMODEMS (ID_NODE) VALUES (3627);
            INSERT INTO SAMPLING (ID_NODE) VALUES (3627);
            INSERT INTO AFECTED_DAYS (ID_NODE) VALUES (3627);
            INSERT INTO STATUS_NODE (ID_NODE) VALUES (3627);
...
#DROP TABLE TOTALMODEMS;
#DROP TABLE NODES;

USE QOE_HELP;
ALTER TABLE NEW_QOE
DROP COLUMN `13/01/2022`;
...
SELECT CMTS, PLANO, `07/01/2022` , `06/01/2022`  FROM SAMPLING
    INNER JOIN NODES ON NODES.ID = SAMPLING.ID_NODE
    WHERE  ((`07/01/2022` < 90 AND `07/01/2022` > 0) OR  (`06/01/2022` < 90 AND `06/01/2022` > 0)) AND REGION = "LIMA"
    ORDER BY `07/01/2022` ASC;
